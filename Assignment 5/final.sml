...
fun inttype (v1,v2,first) =
		if(first = "PLUS") then
		bi2str(add(str2bi(v1),str2bi(v2)))
		else if(first = "MINUS") then 
		bi2str(sub(str2bi(v1),str2bi(v2)))
		else if(first = "MULT") then 
		bi2str(mul(str2bi(v1),str2bi(v2)))
		else if(first = "DIV") then
		bi2str(div4bigint(str2bi(v1),str2bi(v2)))
		else if(first = "MOD") then
		bi2str(mod4bigint(str2bi(v1),str2bi(v2)))
		else if(first = "NEQ") then 
		(if(v1<>v2) then "tt" else "ff")
		else if(first = "EQ") then
		(if(v1=v2) then "tt" else "ff")
		else if(first = "GEQ") then
		(if( geq(str2bi(v1),str2bi(v2)) ) then "tt" else "ff")
        else if(first = "GT") then
		(if( gt(str2bi(v1),str2bi(v2)) ) then "tt" else "ff")
        else if(first = "LEQ") then
		(if( leq(str2bi(v1),str2bi(v2)) ) then "tt" else "ff")
		else if(first = "LT") then
		(if( lt(str2bi(v1),str2bi(v2)) ) then "tt" else "ff")
		else "" ;
...
fun helperunary (v1,first)  =
     	if(first = "UMINUS") then bi2str(unminus(str2bi(v1)))
